  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Learn about the team, mission, and values behind AdRun Pro. We are a passionate team of digital marketing experts."
        />
      </Helmet>
      ...
      <div className="container mx-auto px-4 py-16 transition-colors duration-300">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-gray-700 dark:text-gray-400 max-w-3xl mx-auto">
        ...
        <div className="max-w-4xl mx-auto text-left text-gray-800 dark:text-gray-300 space-y-4">
