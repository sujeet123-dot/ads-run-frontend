...
const AboutPage = () => {
  ...
  return (
    <>
        ...
        <div className="container mx-auto text-center max-w-4xl relative z-10">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
              We Are Your <span className="bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 to-teal-400">Growth Partners</span>
            </h1>
          ...
          {/* Stats Grid */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 border-t border-b border-white/10 py-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {values.map((item, index) => (
              <motion.div 
                ...
                className="bg-[#141625] border border-white/5 p-8 rounded-2xl hover:border-indigo-500/30 transition-colors"
              >
      ...
      <section className="py-20 px-6 bg-[#0a0b14]">
        <div className="container mx-auto flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="md:w-1/2 relative">
            <div className="relative z-10 rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
              ...
              <div className="bg-gradient-to-br from-[#1e2130] to-[#141625] aspect-video flex items-center justify-center group">
