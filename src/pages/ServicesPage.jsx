...
const ServicesPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Our Services | Adsonick</title>
      ...
      {/* --- Section 1: Hero --- */}
      <section className="relative pt-32 pb-20 px-6 bg-[#0a0b14] overflow-hidden">
        {/* Background Blobs */}
      ...
      <section className="py-20 bg-[#0d0e17] px-6">
      ...
      <section className="py-24 px-6 bg-[#0a0b14] border-t border-white/5">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">How We Scale Growth</h2>
            <p className="text-gray-400">Our proven methodology for consistent results.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
            ...
            {processSteps.map((step, index) => (
              <div key={index} className="relative z-10 flex flex-col items-center text-center group">
                <div className="w-16 h-16 rounded-2xl bg-[#141625] border border-white/10 flex items-center justify-center text-indigo-400 mb-6 group-hover:border-indigo-500 group-hover:text-white group-hover:bg-indigo-600 transition-all duration-300 shadow-lg">
                  {step.icon}
                </div>
      ...
      {/* --- Section 4: CTA --- */}
      <section className="py-20 px-6 bg-gradient-to-b from-[#0a0b14] to-[#141625]">
        <div className="container mx-auto text-center max-w-3xl">
          <h2 className="text-3xl font-bold text-white mb-6">Ready to dominate your market?</h2>
          <p className="text-gray-400 mb-8">
            Join the 500+ partners who trust Adsonick to deliver high-quality traffic and conversions.
          </p>
          <Button to="/contact" primary className="px-10 py-4 text-lg">
