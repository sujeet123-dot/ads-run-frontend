...
const Metric = ({ value, label }) => (
  <div className="bg-gray-100 dark:bg-gray-700 p-4 rounded-md text-center transition-colors duration-300">
    <div className="text-3xl font-bold text-green-600 dark:text-green-400">{value}</div>
    <div className="text-sm text-gray-600 dark:text-gray-400">{label}</div>
  </div>
);

const CaseStudy = ({ client, challenge, solution, results }) => (
  <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-300 dark:border-gray-700 mb-12 overflow-hidden transition-colors duration-300">
    <div className="p-8">
      <h3 className="text-2xl font-bold text-gray-900 dark:text-white">{client}</h3>
      <div className="mt-6">
        <h4 className="font-semibold text-lg text-blue-600 dark:text-blue-400">The Challenge</h4>
        <p className="text-gray-700 dark:text-gray-300 mt-2">{challenge}</p>
      </div>
      <div className="mt-6">
        <h4 className="font-semibold text-lg text-blue-600 dark:text-blue-400">Our Solution</h4>
        <p className="text-gray-700 dark:text-gray-300 mt-2">{solution}</p>
      </div>
    </div>
    <div className="bg-gray-50 dark:bg-gray-800/50 border-t border-gray-300 dark:border-gray-700 p-8 transition-colors duration-300">
      <h4 className="font-semibold text-lg text-blue-600 dark:text-blue-400 mb-4">The Results</h4>
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="See real-world results and success stories from our clients. Discover how AdRun Pro drives growth through strategic ad campaigns."
        />
      </Helmet>
      ...
      <div className="container mx-auto px-4 py-16 transition-colors duration-300">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-gray-700 dark:text-gray-400 max-w-2xl mx-auto">
            We don't just promise results—we deliver them. Here's a look at how we've helped businesses like yours succeed.
          </p>
        </div>
