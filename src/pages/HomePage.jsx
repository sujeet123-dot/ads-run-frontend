  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Expertly managed ad campaigns on Google, Meta, and LinkedIn to scale your business. Maximize your ROI with AdRun Pro."
        />
      </Helmet>
      ...
      <section className="py-20 bg-white dark:bg-gray-900 transition-colors duration-300">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="mt-4 text-gray-700 dark:text-gray-400 max-w-2xl mx-auto">
            Let's build a winning strategy for your business. Get in touch for a free, no-obligation proposal.
          </p>
          <div className="mt-8">
